...
export(String) var WORD_MESSAGE = "Lo que siento cada vez que te veo cantar una canción con los ojos cerrados, cada vez que te veo sonreir a un perrito, cada vez que me mandás un mensaje, cada vez que despierto al lado tuyo."
var CURRENT_WORD_ARRAY = {}
var CURRENT_WORD_POSITIONS = {}
var LETTER_COUNT : int
export(int) var ROWS = 6
var CurrentLevel = "res://Scenes/Nivel14.tscn"
