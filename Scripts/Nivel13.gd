...
export(String) var CURRENT_WORD = "BOMBON"
export(String) var WORD_MESSAGE = "Vos"
var CURRENT_WORD_ARRAY = {}
var CURRENT_WORD_POSITIONS = {}
var LETTER_COUNT : int
export(int) var ROWS = 6
var CurrentLevel = "res://Scenes/Nivel13.tscn"
var NextLevel = preload("res://Scenes/Nivel14.tscn")
####################################################################################################
